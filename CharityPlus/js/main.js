...
if (map) {
	function init() {
		const map = new ymaps.Map("map", {
			center: [53.627529570894445, 55.98089749999993],
			zoom: 16
		});

		const placemark = new ymaps.Placemark([53.627529570894445, 55.98089749999993], {}, {
		});
...
/*	Слайд  О НАС */
const MySlider = new Splide('#AboutSlider', {
	type: 'loop',
	perPage: 2,
	autoplay: true,
	interval: 2000,
